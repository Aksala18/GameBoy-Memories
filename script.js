    ...
    9: {
      ...
      11: {
        text: [
            ...
            "",
            "Depois de um dos nossos momentos juntos, comecei a deitar sangue.",
            "Medo, dor, disforia, um ataque de pânico que não conseguia controlar.",
            "",
      ...
      12: {
        text: [
            ...
            "Eu só quero que tenham o meu nome,",
            "ou que pelo menos seja o mesmo.",
            "",
            "Não me importo de adicionar um último nome.",
            "Foi uma discussão,",
            "mas também um sonho partilhado.",
        ],
        inputNeeded: true,
        nextChapter: 13
      },
